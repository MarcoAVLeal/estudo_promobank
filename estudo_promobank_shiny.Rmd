...
# df_bons <- df_score %>% filter(Sinistro6 == 0)
# df_maus <- df_score %>% filter(Sinistro6 == 1)
# 
# 
# seq_score <- seq(0,1,0.01)
# 
# v_bons <- df_bons %>% dplyr::arrange(PREDICT) %>% dplyr::select(PREDICT)
# v_maus <- df_maus %>% dplyr::arrange(PREDICT) %>% dplyr::select(PREDICT)
# cumvalbom <- c()
